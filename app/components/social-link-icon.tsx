...
function resolveKind(linkKey: string, url: string): IconKind {
  ...
  if (url.startsWith("mailto:") || k === "email") return "email"
  if (k.includes("resume") || u.endsWith(".pdf")) return "resume"
  if (u.includes("github.com") || k === "github") return "github"
  if (u.includes("linkedin.com") || k === "linkedin") return "linkedin"
  if (u.includes("instagram.com") || k === "instagram") return "instagram"
...
export function SocialLinkIcon({
  ...
  const kind = resolveKind(linkKey, url)
